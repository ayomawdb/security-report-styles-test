    ...
    <html>
        ...
        <body>
            <div id="front-page">
                ...
                <div id="head">
                    <h2>FindSecurityBugs Static Scan Report for<br/>%%MODULE_NAME%%<br/>(<xsl:value-of select="/BugCollection/Project/@projectName"/>)</h2>
                    <h3 style="margin-top:50px;">Version: %%MODULE_VERSION%%</h3>
